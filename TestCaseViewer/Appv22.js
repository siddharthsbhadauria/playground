            ...
            <main>
                <div className="columns">
                    ...
                    <section className="column">
                        ...
                        {metrics.length > 0 && metrics.map((metric, index) => (
                            <div key={index} style={{ backgroundColor: metric.threshold && metric.score > metric.threshold ? '#9fdf9f' : '#f99f9f' }}>
                                <h3>{metric.metric}</h3>
                                <table className="table-container">
                                    <tbody>
                ...
                <section>
                    ...
                    <div className="bar-graph">
                        {metrics.length > 0 && metrics.map((metric, index) => (
                            <div key={index} className="bar" style={{ width: `${metric.score * 100}%`, backgroundColor: metric.threshold && metric.score > metric.threshold ? '#9fdf9f' : '#f99f9f' }}>
                    ...
                    <div className="y-axis">
                        {metrics.map((metric, index) => (
                            <div key={index} className="y-label">{metric.metric}</div>
                        ))}
                    </div>
                </section>
            </main>
