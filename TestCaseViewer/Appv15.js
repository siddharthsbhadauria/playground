        ...
        if (selectedTestCase && selectedFile) {
            axios.get(`/api/file/${selectedFile}`).then(response => {
                ...
                if (testCase) {
                    ...
                    const metricsData = testCase.metricsMetadata || [];
                    const metricsDetails = metricsData.map(metric => {
                        const details = {};
                    ...
                    setMetricsDetails(metricsDetails);
                    ...
                    <section className="column">
                        ...
                        {metrics.length > 0 && (
                            <table className="table-container">
                                ...
                                <tbody>
                                    {metricsDetails.map((metric, index) => (
                                        <tr key={index}>
                                            <td>{metrics[index].metric}</td>
                                            <td>
                                                <ul>
